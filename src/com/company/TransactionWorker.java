...
public class TransactionWorker{
    ...
    List<String> soldMaterials = new ArrayList<>();
    ...
    private class Transaction{
        ...
        public String getNameOfMaterial(){return this.nameOfMaterial;}
        public String getDateOfTransaction(){return this.dateOfTransaction;}
        public int getQuantityOfSoldMaterial(){return this.quantityOfSoldMaterial;}
        public int getTotalSumOfPurchase(){return this.totalSumOfPurchase;}
    }
    ...
    private void createAllTransactions()throws SQLException, IOException, ClassNotFoundException{
        try {
            ...
            while (res.next()){
                ...
                String matName = res.getString("Name");
        ...
        if(buyerQuantity>neededMaterial.getQuantity()){
            ...
            switch (customerChoice){
                case 1:
                    ...
                    soldMaterials.add(String.format(
                            "\nID: %d\nName of product: %s\nPrice: %d\nQuantity: %d\nTotal for that material:%d",
                            neededMaterial.getId(),neededMaterial.getName(),neededMaterial.getPrice(),neededMaterial.getQuantity(),totalSumForOneMaterial));
            ...
            soldMaterials.add(String.format(
                    "\nID: %d\nName of product: %s\nPrice: %d\nQuantity: %d\nTotal for that material:%d",
                    neededMaterial.getId(),neededMaterial.getName(),neededMaterial.getPrice(),buyerQuantity,totalSumForOneMaterial));
